...
traindir = '/scratch/train.lmdb'
valdir   = '/scratch/val.lmdb'
...
train_loader  = torch.utils.data.DataLoader(train_dataset, batch_size=128*4, shuffle=True,num_workers=4, pin_memory=True)
